...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderColor = a.getColor(R.styleable.CircleImageView_border_color, Color.BLACK);
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_border_overlay, false);
        a.recycle();
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2f, getHeight() / 2f, mDrawableRadius, mPaint);
        if (mBorderWidth > 0) {
    ...
    private void setup() {
        ...
        mBorderRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2f,
    ...
    private void updateShaderMatrix() {
        ...
        matrix.postTranslate((int) (dx + 0.5f) + mDrawableRect.left,
